    ...
    <section>
        <div class="box">
            <form id="login-form" method="POST" action="login.php">
                ...
                <div>
                    <button type="submit" class="btn btn-primary my-3" id="login-btn" name="login_btn" value="LOGIN">Login</button>
                </div>
                <a href="register.html" class="btn btn-primary my-3">Register</a>
                </div>
                </div>
            </form>
        </div>
